...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MAProdutos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MAProdutosActionPerformed(evt);
            }
        });
    ...
    private void MAProdutosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MAProdutosActionPerformed
        frmProdutos msProdutos = new frmProdutos();
        msProdutos.setDados(msDados);
        dpnDesktop.add(msProdutos);
        msProdutos.show();
    }//GEN-LAST:event_MAProdutosActionPerformed

    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ((BackGround)dpnDesktop).setImagem("/imagens/Kaboomga!.png");
